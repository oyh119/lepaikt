 ...
 */
class HomePagePresenter @Inject constructor(val service: InitService, val view: HomePageContract.View, private val storeHolder: StoreHolder) : HomePageContract.Presenter{
